...
var filter = m => m.author.id === message.author.id;
      ...
      message.channel.send(`:eight_pointed_black_star:| **Çekilişin yapılacağı kanalın adını yaz** ( Kanal Adını Yazarken "#" Koymamalısın, Sadece İsmini Kopyala Ve Yaz )`).then(msg => {
      message.channel.awaitMessages(filter, {
        ...
        if(!room) return message.channel.send(':heavy_multiplication_x:| **Böyle bir kanal bulamadım** ( Böyle Bir Kanal Yok Veya Kanal İsminin Başına "#" Koydun! )');
        ...
        msg.edit(':eight_pointed_black_star:| **Çekilişin süresini belirle (1s, 1m, 1h, 1d, 1w)**').then(msg => {
          message.channel.awaitMessages(filter, {
            ...
            collected.first().delete();
            msg.edit(':eight_pointed_black_star:| **Ödülü Belirle**').then(msg => {
              message.channel.awaitMessages(filter, {
                max: 1,
                time: 20000,
                errors: ['time']
                ...
                try {
                  ...
                  .setFooter(message.author.username + " Orcal Çekiliş", message.author.avatarURL);
			...
			.setFooter("(Orcal Çekiliş)")
                     ...
                     m.edit('** 🎉 ÇEKİLİŞ BİTTİ 🎉**' , {embed: endEmbed});
                       ...
                       var embedLel = new Discord.RichEmbed()
                        .setColor("#f558c9")
                        .setDescription("Ödülünü destek talebi açarak elde edebilirsin!").setFooter("(Orcal Çekiliş)")
...
exports.help = {
  name: 'çekiliş',
  description: 'Çekiliş Zamanıııı :3',
  usage: 'çekiliş'
};
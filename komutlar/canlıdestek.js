...
const emoji7 = message.client.emojis.get('📞');
      ...
      let destekKanal = "544509478880411648";
    ...
    collector.on('end', (collected, reason) => {
      ...
      if (reason === 'aborted') {
        message.reply('⛔️ **Çağrı reddedildi.**')
        client.channels.get(destekKanal).send('⛔️ **Başarıyla çağrı reddedildi.**')
      }
      if (reason === 'success') {
        ...
        chan.send('♦️ En Yakın Zamanda Size Yardımcı Olacagız.')
...
exports.help = {
  name: 'canlıdestek',
  description: 'Canlı Destek Tablebi Oluştur Ve Konuş!',
  usage: 'canlıdestek'
};